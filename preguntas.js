...
q(160, "En un montaje Darlington, ¿cuál es la mínima tensión entre emisor y base del par Darlington para que el tramo emisor-colector se vuelva conductor?", "5V", "0,7V", "1,4V", "Varía según el tipo de transistor", "c");
q(161, "¿Es posible codificar una unidad de control a través de internet?", "sí, mediante un codificado online", "no, esta operación es imposible de realizar", "Depende de su caracterización", "Fluctúa en base a sus dimensiones de medida", "a");
...
q(166, "Los compresores accionados por motor térmico están previstos de un sistema que evita superar la presión de trabajo, ¿de cuál se trata?", "válvula de seguridad", "válvula de timbrado", "válvula de purga", "válvula presostática", "d");
...
q(170, "¿Para medir amperaje con un multímetro qué es lo que se debe hacer?", "en el multímetro se selecciona amperios; conectado en paralelo", "en el multímetro se selecciona amperios; conectado en serie sin protección", "en el multímetro se selecciona amperios; conectado en serie usando la escala más alta para proteger el multímetro", "", "c");
q(171, "¿Para medir caída de tensión con un multímetro qué es lo que se debe hacer?", "los bornes en las clavijas, luego con las puntas colocar en los puntos de lectura donde se quiere medir, teniendo en cuenta que el vehículo debe estar en contacto o encendido", "colocar el borne o punta del cable del multímetro en cualquier punto del chasis o masa del vehículo y la otra punta en el punto donde quiera medir, vehículo encendido o apagado", "colocar la punta del cable del multímetro en el chasis o carrocería y la otra punta en el punto de lectura, vehículo apagado", "", "a");
q(172, "¿Para medir intensidad con un multímetro qué es lo que se debe hacer?", "Se abre el circuito en cualquiera de sus puntos, y configura (borne rojo en clavija de más capacidad, borne negro en clavija común COM)", "Se abre el circuito y se conecta en paralelo, luego adecuado (borne rojo en clavija de más capacidad, borne negro en COM)", "Se abre el circuito y configura adecuadamente, borne rojo en clavija de más capacidad, negro en COM, circuito apagado", "", "a");
q(173, "¿Para medir resistencia con un multímetro qué es lo que se debe hacer?", "Se debe colocar la ruleta en la posición de ohmios y en la escala apropiada al tamaño de la resistencia, sin voltaje circulando", "Se debe colocar la ruleta en ohmios y escala según resistencia, aunque haya voltaje circulando", "Se coloca en la escala más grande y se reduce hasta precisión con corriente circulando", "", "a");
q(174, "¿Para medir voltaje absoluto con un multímetro qué es lo que se debe hacer?", "Colocar los bornes en las clavijas, luego en los puntos de lectura, vehículo en contacto o encendido", "Colocar el borne o punta del multímetro en cualquier punto del chasis o masa del vehículo y la otra punta en el punto donde quiera medir, vehículo en contacto o encendido", "Colocar la punta en chasis y otra en punto de lectura, vehículo apagado", "", "b");
q(175, "¿Qué componentes conforman el sistema electrónico del ABS en el vehículo?", "Módulo del ABS, sensor de ruedas, batería, testigo ABS, cuerpo de válvulas, conector de diagnóstico", "Módulo del ABS, sensor de ruedas, motor de bomba, pastillas de freno, cuerpo de válvulas, conector", "Módulo del ABS, sensor de régimen, pastillas y zapatas, testigo ABS, cuerpo de válvulas, interruptor de encendido", "Todas las anteriores", "a");
q(176, "¿Qué distancia es la recomendada para la separación de un sensor captador y su entrehierro?", "De 0.5 a 2 mm", "De 1 a 3 mm", "De 0.4 a 0.9 mm", "", "c");
...
q(179, "Según la impedancia describe principalmente la resistencia eléctrica que tiene la bobina del inyector, cual es el valor de la resistencia de los inyectores de alta y de baja?", "Impedancia baja 2,5 a 4,5 ohmios, alta 10 a ...", "Impedancia baja 1,7 a 3 ohmios, alta 14 a 16 ohmios", "Impedancia baja 1,7 a 3 ohmios, alta 10 a 16 ohmios", "", "c");
q(180, "Si al medir la compresión en un vehículo de cuatro cilindros, en tres cilindros se tiene 130 PSI y en un cilindro 80 PSI, ¿cuál es el problema?", "falla en altas revoluciones", "falla en bajas revoluciones", "existe torcedura en las válvulas", "no genera una correcta relación de compresión", "d");
q(181, "¿Qué función se debe activar en la unidad de control de un vehículo para modificar parámetros mediante valores de corrección?", "La función de osciloscopio", "La función del multímetro", "La función de adaptación", "La función de lectura de bloques de valores", "c");
...
q(189, "¿Con qué función del equipo de diagnosis se pueden ajustar los ciclos de regulación de una unidad de control?", "Con el diagnóstico de actuadores", "Con el codificado de la unidad de control", "Con el ajuste básico", "Con el borrado de memoria de averías", "c");
...
q(191, "¿Dónde se emplean los motores paso a paso en un automóvil?", "En los mecanismos en donde se requieren movimientos muy precisos", "En los mecanismos de dirección", "En los mecanismos que se necesita mucho par de giros", "En los mecanismos que tienen que girar muy despacio", "a");
q(192, "¿Los casquillos de las lámparas de halógenos están fabricados generalmente con?", "Fundición", "Cobre", "Plomo", "Latón", "d");
q(193, "¿Para qué se realiza la adaptación del cuadro de instrumentos?", "Para ajustar la configuración del cuadro y los valores de intervalos de servicio", "Para que la gestión electrónica reconozca el cuadro sustituido", "Para identificar las averías del cuadro", "Ninguna de las respuestas anteriores", "b");
q(194, "¿Qué duración aproximada en horas de funcionamiento tienen las lámparas de xenón?", "250 h", "500 h", "2500 h", "1000 h", "c");
...
q(196, "¿Qué misión realiza la red CAN BUS de datos en los circuitos eléctricos?", "Permite a los módulos electrónicos compartir todas las señales de sus captadores", "Se emplea para estabilizar la tensión de los módulos electrónicos", "Se emplea para leer memoria de averías de los módulos", "Localiza rápidamente lámparas fundidas", "a");
q(197, "¿Qué misión realiza la red CAN en los circuitos que disponen de ella?", "Alimentar con la tensión los módulos de gestión", "Conectar los módulos a masa", "Conectar entre sí los módulos de gestión y transmitir información", "Conectar los captadores y módulos de gestión", "c");
q(198, "¿Qué misión tienen las luces de gálibo?", "Alumbrar la calzada", "Alumbrar la calzada marcha atrás", "Señalar la anchura del vehículo", "Señalar la anchura y la altura del vehículo", "d");
q(199, "¿Qué números se utilizan para señalar en los esquemas la presión y el escape?", "4; 4,8", "2,3,5", "1; 3,5", "1,2,3", "c");
q(200, "¿Qué ocurre si en CAN-High se deriva a masa?", "Que deja de haber comunicación en el CAN-Bus", "Que la información pasa por CAN-Low y no se amplifica la señal", "Que el CAN-Low también se deriva a masa", "Que las señales se vuelven analógicas", "b");
...
q(203, "¿Qué temperatura puede alcanzar una bombilla incandescente de luz blanca cálida?", "600 K", "150 K", "2700 K", "8000 K", "c");
...
q(205, "¿Qué válvula accionada por efecto de la carga y descarga regula la cantidad de aire que entra y sale del fuelle?", "Válvula de alivio", "Válvula limitadora de presión", "Válvula de nivel", "Válvula limitadora de altura", "c");
q(206, "Afirmación: La unidad electrónica ROM es la unidad donde se recibe la información de los sensores del sistema, mientras que la unidad electrónica RAM es la unidad que tiene almacenados los mapas característicos de control. ( )", "Verdadero", "Falso", "", "", "b");
q(207, "Afirmación: La función de programación y adaptación en los escáneres es de mucha importancia para vehículos con sistemas de unidades de control, bolsas de aire, alarmas, inmovilizadores, etc.", "Verdadero", "Falso", "", "", "a");
q(208, "Afirmación: El escáner tiene la opción de prueba de actuadores (bloquear puertas, encender bomba, corte de combustible, etc.).", "Verdadero", "Falso", "", "", "a");
q(209, "Afirmación: Los escáneres detectan todas las unidades de control electrónico instaladas en el auto y leen códigos de error.", "Verdadero", "Falso", "", "", "a");
q(210, "Afirmación: En determinados sensores se utilizan etapas intermedias no eléctricas. En ABS se emplean sensores pasivos y activos magnetorresistivos.", "Verdadero", "Falso", "", "", "a");
q(211, "Afirmación: En determinados sensores se utilizan etapas intermedias no eléctricas; en ABS se emplea sensores pasivos y activos magnetorresistivos.", "Verdadero", "Falso", "", "", "a");
q(212, "Afirmación: La rueda mueve el anillo dentado ferromagnético, generando líneas de fuerza del imán e induciendo en el bobinado del sensor de régimen una tensión alterna cuadrada.", "Verdadero", "Falso", "", "", "b");
q(213, "Afirmación: Algunos scanner solo pueden leer códigos que presentan problemas; para interpretarlos es necesario el manual respectivo.", "Verdadero", "Falso", "", "", "a");
];
